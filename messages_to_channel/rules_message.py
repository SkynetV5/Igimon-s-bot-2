...
def rules_message():
    ...
    embed = discord.Embed(title="Rules/Regulamin", description="Przeczytaj regulamin, a następnie dodaj reakcję, aby zaakceptować.\n\n"
                "✅ - Akceptuję regulamin", color=0xff0000)
    i = 0
